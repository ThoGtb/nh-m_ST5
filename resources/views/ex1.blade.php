...
<nav class="navbar navbar-expand-sm bg-light">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">San Pham</a>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="page3.blade.php">Bàn</a></li>
      <li><a class="dropdown-item" href="page4.blade.php">Ghế </a></li>
